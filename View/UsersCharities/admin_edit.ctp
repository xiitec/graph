...
<?php echo $this->Form->create('UsersCharity'); ?>
	<fieldset>
		<legend><?php echo __('Admin Edit Users Charity'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('UsersCharity.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('UsersCharity.id'))); ?></li>
